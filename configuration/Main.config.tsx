    ...
    introduce: [
        {
            ...
            description: '결국 내가 하고싶었던 것은 사용자와의 소통이었습니다. \
            나름대로 오랜시간동안 다양한 개발 분야를 공부해왔습니다. 하지만 그 \
        ...
        },
        {
            ...
            description: '용자가 즐겁게 사용할 수 있는 개발을 중시합니다. 즐거운 \
            사용은 단순하지 않다고 생각합니다. 퍼포먼스, , 디자인, \
        ...
        {
            title: '재사용, 그것은 나의 목표',
            description: '사용자의 즐거움이 구성 목표라면 재사용성이 높은 코드는 \
            개발자로서 목표입니다. 항상 코드를 짜기 전, 혹은 짜면서 항상 \
            컴포넌트를 지속적으로 재사용할 수 있게끔 작성하도록 노력합니다. \
            코딩을 하면서 몇번이나 했던 작업을 반복하게 되는 것은 엄청난 \
        ...
        },
        {
            ...
            description: '팀과 작업의 방향을 맞추고 어떻게 자료를 공유할지 규정하는 \
            것을 굉장히 중요하게 생각합니다. 부끄럽지만 20년까지만 하더라도 전혀 \
